    ...
    <div class="container-fluid ">
      ...
      <div class="border border-3 row">
        <div class="col-lg-9 row float-lg-end">
          ...
          <a class="nav-link col-lg-2" href="/employees">Employee</a>
          <a class="nav-link col-lg-2" href="/customers">Customer</a>
          <a class="nav-link col-lg-2" href="/services">Service</a>
